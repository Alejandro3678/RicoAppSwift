...
struct SeccionCuerpoPerfilView: View {
    @StateObject private var usuariosViewModel = UsuarioViewModel()
    let userID: String
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false){
            VStack(alignment: .center, spacing: 10){
                ...
                if let usuario = usuariosViewModel.usuario {
            ...
            .onAppear{
                usuariosViewModel.fetchDataUsuarios(userID: userID)
            }
        }
    }
}
